...
import { BillingAccount, ConsoleProfile, ConsoleSection, ConsoleUsageStatus, EmailFormState, EnterpriseVerification, Language, LoginMessage, MFAEnrollment, MFAStatus, ModelStatusReport, PasswordFormState, PaymentOrder, Principal, ProfileFormState, ProjectFormState, ProjectMember, ProjectSummary, PublicAPIEndpoint, PublicPaymentProvider, TenantMember, TokenGroupOption, TokenSummary, TranslationKey, UsageRecord, UsageReport } from "@/types";
...
interface ConsoleViewProps {
  ...
  createPaymentOrder: (provider: PaymentOrder["provider"], amount: string, currency: string) => Promise<void>;
    ...
    <div className="flex min-h-[calc(100vh-72px)] w-full bg-slate-50 dark:bg-slate-950">
      ...
      <div className="min-w-0 flex-1 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[1560px] space-y-6">
          ...
          {displayedSection === "billing" ? <BillingPanel language={language} t={t} billingAccount={billingAccount} billingBusy={billingBusy} billingMessage={billingMessage} refreshBilling={refreshBilling} paymentProviders={paymentProviders} paymentBusy={paymentBusy} paymentMessage={paymentMessage} paymentOrder={paymentOrder} createPaymentOrder={createPaymentOrder} refreshPaymentOrder={refreshPaymentOrder} capturePayPal={capturePayPal} /> : null}
